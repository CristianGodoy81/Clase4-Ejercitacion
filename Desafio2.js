...
let pagoMes=5000;
let consumoKWH=450;
let pagoIncrementado=pagoMes+(pagoMes*20)/100;
let mensajeDeAumento="Debido a que su hogar tuvo un consumo de: "+consumoKWH+"KWH,"+
" en base al ajuste tarifario hogares con consumo mayor a 300kwh por mes tendrán un aumento del 20%),"+
" cumplimos con informarle que se ha ajustado el total a pagar, que será de: $"+pagoIncrementado;
(consumoKWH>300)?console.log(mensajeDeAumento):console.log("Mantiene subsidios");